...
if application == "Pressure Profile":
    ...
    k = st.sidebar.slider("permeability (md)", min_value=10, max_value=200, value=50)
    ...
    kg = st.sidebar.number_input("Enter Gas Permeability(md)", min_value=1, max_value=200, value=20)
